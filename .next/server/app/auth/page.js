...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7__);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8411)), "D:\\FRONTEND\\NEXT JS\\NEXT_BLOG\\my-blog-app\\app\\auth\\page.tsx"]}]
      },
        {
...
'head': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 447)), "D:\\FRONTEND\\NEXT JS\\NEXT_BLOG\\my-blog-app\\app\\head.tsx"],
    ...
    const metadata = [{
          ...
          type: 'page',
          layer: 1,
          mod: () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8411)),
          path: "D:\\FRONTEND\\NEXT JS\\NEXT_BLOG\\my-blog-app\\app\\auth\\page.tsx",
        },];
    const pages = ["D:\\FRONTEND\\NEXT JS\\NEXT_BLOG\\my-blog-app\\app\\auth\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8257))
...
/* harmony import */ var _componetns_AuthForm_AuthForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6091);
/* harmony import */ var _componetns_AuthForm_AuthForm__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_componetns_AuthForm_AuthForm__WEBPACK_IMPORTED_MODULE_2__);



async function Auth() {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_componetns_AuthForm_AuthForm__WEBPACK_IMPORTED_MODULE_2___default()), {});
}
...
module.exports = createProxy("D:\\FRONTEND\\NEXT JS\\NEXT_BLOG\\my-blog-app\\componetns\\AuthForm\\AuthForm.tsx");
...
;// CONCATENATED MODULE: ./helpers/createUser.ts
...
;// CONCATENATED MODULE: ./componetns/AuthForm/AuthForm.tsx
...
function AuthForm() {
    const [isLogin, setIsLogin] = (0,react_.useState)(true);
    const [email, setEmail] = (0,react_.useState)("");
    const [pass, setPass] = (0,react_.useState)("");
    const [errorMsg, setError] = (0,react_.useState)("");
    ...
    async function submitHandler(event) {
        ...
        setError("");
        if (isLogin) {
            const result = await (0,react.signIn)("credentials", {
                redirect: false,
                email,
                password: pass
            });
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("section", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
            ...
            children: logged ? /*#__PURE__*/ jsx_runtime_.jsx("p", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "buttons is-centered m-0",
                    ...
                    errorMsg === "userExists" && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
