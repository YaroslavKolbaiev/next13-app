...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7__);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4958)), "D:\\FRONTEND\\NEXT JS\\NEXT_BLOG\\my-blog-app\\app\\newpost\\page.tsx"]}]
      },
        {
...
module.exports = createProxy("D:\\FRONTEND\\NEXT JS\\NEXT_BLOG\\my-blog-app\\app\\newpost\\NewPost.tsx");
...
/* harmony import */ var _NewPost__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5948);
/* harmony import */ var _NewPost__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_NewPost__WEBPACK_IMPORTED_MODULE_2__);



async function PostPage() {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_NewPost__WEBPACK_IMPORTED_MODULE_2___default()), {});
}
...
function NewPost() {
    ...
    const [imageUrl, setImageUrl] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)("");
    const [excerpt, setExcerpt] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)("");
    const [isLoading, setIsLoading] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(true);
    const [uploadProgress, setUploadProgress] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(-1);
    const { data: session  } = (0,next_auth_react__WEBPACK_IMPORTED_MODULE_1__.useSession)();
    const fileInputRef = (0,react__WEBPACK_IMPORTED_MODULE_3__.useRef)();
    const [isPosted, setIsPosted] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    const switchOffMsg = ()=>{
        setTimeout(()=>{
            setIsPosted(false);
        }, 3000);
    ...
    async function addPostHandler(e) {
        e.preventDefault();
        const generatedFileId = (0,uuidv4__WEBPACK_IMPORTED_MODULE_2__/* .uuid */ .Vj)();
        const newPost = {
        ...
        try {
            axios__WEBPACK_IMPORTED_MODULE_8__/* ["default"].post */ .Z.post("/api/posts", newPost);
            setIsPosted(true);
            switchOffMsg();
        } catch (error) {
    ...
    function handleFile(event) {
        (0,_helpers_handleFileChange__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(event, setUploadProgress, setImageUrl, setFileInputRef);
    }
    function handleCancel() {
        (0,_helpers_handleCancelImageClick__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(imageUrl, setFileInputRef, setImageUrl, setUploadProgress);
    }
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        (0,next_auth_react__WEBPACK_IMPORTED_MODULE_1__.getSession)().then((sessionRes)=>{
            if (!sessionRes) {
    ...
    if (isLoading) {
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_componetns_LoadingComp_LoadingComp__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {});
    }
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
                                ...
                                children: [
                                    ...
                                    uploadProgress > -1 && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("progress", {
                                        className: "progress",
                                    ...
                                    imageUrl && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            ...
                            isPosted && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                className: "notification is-success",
                                children: "New post created"
                            })
                        ]
                    })
                })
...
var __webpack_exports__ = __webpack_require__.X(0, [684,449,260,844,169], () => (__webpack_exec__(871)));
